...
public class RerunnableFunctionTest {
    ...
    public void testSuccessfulRunningWillReturnWithResult() {
        // given
        final Function<Boolean, String> testSubject = RerunnableFunction.doTry(function).times(1);
    ...
    public void testAfterSuccessfulAttemptWillReturnWithResult() {
        // given
        final Function<Boolean, String> testSubject = RerunnableFunction.doTry(function).times(2);
    ...
    public void testZeroTimesWillNotCallDecorated() {
        // given
        final Function<Boolean, String> testSubject = RerunnableFunction.doTry(function).times(0);
    ...
    public void testExpectedNumberOfTriesWillBeExecuted() {
        ...
        final Function<Boolean, String> testSubject = RerunnableFunction.doTry(function).times(numberOfAttempts);
